const config = {
  ...
  shortTitle: 'FM Single price grid component',
  // Project description. Used in SEO meta tag and by PWA
  description: 'My solution for Frontend Mentor "Single price grid component" challenge',
  ...
  baseUrl: 'https://p1t1ch-fm-single-price-grid-component.netlify.app',
